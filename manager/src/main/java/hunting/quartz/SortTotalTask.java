 ...
 *
 */
@Service("sortTotalTask")
public class SortTotalTask {
    ...
    public void execute(){        
        ...
        if (!CollectionUtils.isEmpty(citys)) {
            ...
            for (String city : citys) {
                List<Integer> sortList = playerHoldLogoDao.sort(city, "2014-01-01 00:00:00", yesterDayStr+" 23:59:59");
                List<Map<String, Object>> res =  playerHoldLogoDao.top(city, "2014-01-01 00:00:00", yesterDayStr+" 23:59:59", limit, offset);
